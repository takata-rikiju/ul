...
const developerInstructions = [
  ...
  "CHARACTER COUNT USAGE (MANDATORY):",
  "- Character counts for each field are provided in the input.",
  "- You MUST consider character counts when generating revision instructions.",
  "CHARACTER-QUALITY DECISION RULES:",
  "- If a field is near or at the character limit AND lacks specificity, instruct the student to REMOVE vague or repetitive phrases and REPLACE them with concrete details (numbers, actions, outcomes).",
  "- If a field is well below the character limit AND lacks key information, instruct the student to ADD specific details.",
  "- If a field is near the character limit AND already specific, instruct only minor trimming if needed; do not add new content.",
  "- Prefer 'cut low-value words first, then add high-value specifics'.",
  ...
  "- When relevant, explicitly mention the character strategy in the comment (e.g., '表現を削って空いた文字数で○○を追加').",
  "- Do NOT state exact character numbers unless clearly provided; focus on strategy (cut vs add).",
